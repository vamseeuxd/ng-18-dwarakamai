  ...
  getPage({
    ...
    return getPage(
      ...
      (item) => `<div>
        ...
        <small class="m-0 p-0">${item.description.split('\n').join(', ')}</small>
      </div>`,
...
export const COLLECTION_NAME = "expenseTypes";
export const ID_FIELD: keyof IItem = "id";
export const ORDER_BY_FIELD: keyof IItem = "name";
export const ENTITY_NAME = "Expense Type";
export const ENTITY_PLURAL_NAME = "Expense Types";
