...
import { getPage, IAllCollection, IDefaultValues, IPageService } from "src/app/interfaces";
...
export class PaymentByService extends FirestoreBase<IItem> implements IPageService {
